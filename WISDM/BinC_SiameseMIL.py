...
if __name__ == '__main__':
    ...
    for group in groups:
        if(ifsmooth):
            datapath = './attackdataset/' + group + '/BinC/smooth/'
            if (overlap == 0.5):
                outpath = './results/BinC/smooth/models36/'
            else:
                outpath = './results/BinC/smooth/models15/'
        else:
            datapath = './attackdataset/' + group + '/BinC/nonsmooth/'
            if (overlap == 0.5):
                outpath = './results/BinC/nonsmooth/models36/'
            else:
                outpath = './results/BinC/nonsmooth/models15/'
