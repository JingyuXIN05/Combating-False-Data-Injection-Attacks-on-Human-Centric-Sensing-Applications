...
if __name__ == '__main__':
    ...
    for group in groups:
        if(ifsmooth):
            datapath = './attackdataset/' + group + '/AinC/smooth/'
            if (overlap == 0.5):
                outpath = './results/AinC/smooth/models36/'
            else:
                outpath = './results/AinC/smooth/models15/'
        else:
            datapath = './attackdataset/' + group + '/AinC/nonsmooth/'
            if (overlap == 0.5):
                outpath = './results/AinC/nonsmooth/models36/'
            else:
                outpath = './results/AinC/nonsmooth/models15/'
        ...
        #net.apply(SiameseNetWISDOM.init_weights)
