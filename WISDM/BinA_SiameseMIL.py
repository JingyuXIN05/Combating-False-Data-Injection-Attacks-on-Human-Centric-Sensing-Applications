...
if __name__ == '__main__':
    ...
    for group in groups:
        if(ifsmooth):
            datapath = './attackdataset/' + group + '/BinA/smooth/'
            if (overlap == 0.5):
                outpath = './results/BinA/smooth/models36/'
            else:
                outpath = './results/BinA/smooth/models15/'
        else:
            datapath = './attackdataset/' + group + '/BinA/nonsmooth/'
            if (overlap == 0.5):
                outpath = './results/BinA/nonsmooth/models36/'
            else:
                outpath = './results/BinA/nonsmooth/models15/'
