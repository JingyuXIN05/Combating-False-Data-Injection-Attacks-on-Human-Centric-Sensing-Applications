# this file is for attack cases that inject taking stairs (activity C) data into walking (activity A) data
...
if __name__ == '__main__':
    ...
    for group in groups:
        if(ifsmooth):
            datapath = './attackdataset/' + group + '/CinA/smooth/'
            if (overlap == 0.5):
                outpath = './results/CinA/smooth/models36/'
            else:
                outpath = './results/CinA/smooth/models15/'
        else:
            datapath = './attackdataset/' + group + '/CinA/nonsmooth/'
            if (overlap == 0.5):
                outpath = './results/CinA/nonsmooth/models36/'
            else:
                outpath = './results/CinA/nonsmooth/models15/'
